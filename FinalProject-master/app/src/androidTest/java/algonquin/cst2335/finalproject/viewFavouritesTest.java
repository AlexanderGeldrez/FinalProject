...
public class viewFavouritesTest {
    ...
    @Test
    public void viewFavouritesTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.latitudeInput),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("59"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.longitudeInput),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("29"), closeSoftKeyboard());
        ...
        ViewInteraction viewGroup = onView(
                allOf(withId(R.id.favoritesToolbar),
