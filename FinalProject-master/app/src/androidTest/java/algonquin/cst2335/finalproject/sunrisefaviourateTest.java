...
public class sunrisefaviourateTest {
    ...
    @Test
    public void sunrisefaviourateTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.latitudeInput),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("58"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.longitudeInput),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("73"), closeSoftKeyboard());
