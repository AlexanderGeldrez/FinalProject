...
public class deleteAllTest {
    ...
    public void deleteAllTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.longitudeInput),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("59"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatButton6 = onView(
                allOf(withId(R.id.deleteAllButton), withText("Delete All"),
                        childAtPosition(
        ...
        ViewInteraction button = onView(
                allOf(withId(R.id.deleteAllButton), withText("DELETE ALL"),
                        withParent(allOf(withId(R.id.favoritesToolbar),
