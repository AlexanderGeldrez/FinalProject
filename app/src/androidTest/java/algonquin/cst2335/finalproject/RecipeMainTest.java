...
public class RecipeMainTest {
    ...
    public void recipeMainTest() {
        ...
        ViewInteraction materialButton = onView(withId(android.R.id.content));
        materialButton.perform(click());

        ViewInteraction editText = onView(withId(R.id.searchEditText));
        editText.check(matches(withText("egg")));
    }
